      ...
      <div className="partContainer">
        ...
        <div className="partrightAbout">
          <p>
            ...
            Hackerrank */}
            Hello, My name is Venu I have completed mu Bchelors of technology
            from JNTUH, My skills includes a Good foundation in Python Java and
            ...
            also practiced coding by solving problems on various coding
            platforms like Leetcode, GFG and Hackerrank
          </p>
          <a
            href="https://drive.google.com/file/d/1ukXWjoNiIfWU-oy04fUJc9K69KH_Fl5g/view?usp=drive_link"
            target="_blank"
            rel="noreferrer"
          >
            My Resume
